...
//app.use("/lab8", middleware.checkTokenCookies, express.static('lab8'))
//app.use("/lab8", middleware.checkTokenCookies, express.static('web'))
...
app.listen(process.env.PORT || 5005, () => {
    console.log("Server up and running on port: " + (process.env.PORT || 5005));
});
